...
//  Project5
//
//  Created by Catalin Neculaide on 07.03.2021.
//
...
class ViewController: UITableViewController {
    ...
    func submit(_ answer: String){
        ...
        if (lowerAnswer != title?.lowercased()){
            ...
            errorTitle = "Word exactly the same as \(title!.lowercased())"
            errorMessage = "You cant just answer the title word"
        }
